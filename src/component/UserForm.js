    ...
    render() {
        ...
        return (
            ...
            <div className="form-group">
                <label>Name</label>
                <input type = "text" 
                    className = {isError.name.length > 0 ? "is-invalid for-control": "form-control"}
                    name = "name"
            ...
            <div className="form-group">
                <label>Email</label>
                <input type="email" 
                    className = {isError.email.length > 0 ? "is-invalid for-control": "form-control"}
                    name = "email"
                    onChange={this.formValChange}
                    />
                {isError.name.length > 0 && (
            ...
            <div className="form-group">
                ...
                <input type = 'password' className="form-control"
                    className = {isError.password.length > 0 ? "is-invalid for-control": "form-control"}
                    name = "password"
                    onChange={this.formValChange}
                    />
                {isError.name.length > 0 && (
